  ...
  <nav class="py-2 fixed-top">
    <div class="container d-flex flex-wrap">
      <ul class="nav me-auto">
        ...
        <li class="nav-item"><a href="#" class="nav-link px-2">Ожидается</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">Каталог</a></li>
      ...
      <div class="flex-shrink-0 dropdown">
        ...
        <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser2" style="">
          <li><router-link class="dropdown-item" to="/sign-in/">Регистрация</router-link></li>
          <li><hr class="dropdown-divider"></li>
          <li><a class="dropdown-item" href="/register/">Вход</a></li>
        </ul>
      </div>
